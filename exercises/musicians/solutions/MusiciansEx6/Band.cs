...
public class Band {
    ...
    protected List<MusicianCreatorBase> musicianCreators;
    ...
    public Band()
    {
        ...
        this.musicianCreators = new List<MusicianCreatorBase>();
    }
    ...
    public void RegisterMusicianCreator(MusicianCreatorBase creator)
    {
